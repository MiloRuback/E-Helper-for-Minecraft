...
O workflow `.github/workflows/release.yml` cria a release quando uma tag `v*` e enviada. A versao atual e `v0.1.8`.
...
```text
Every-Helper-for-Minecraft-Setup-0.1.8.exe
https://drive.google.com/file/d/1npnO2xchqdWqPAiWbYFiYbCvhx3SpZFv/view?usp=drivesdk
```
