...
O workflow `.github/workflows/release.yml` cria a release quando uma tag `v*` e enviada. A versao atual e `v0.1.12`.
...
```text
Every-Helper-for-Minecraft-Setup-0.1.12.exe
https://drive.google.com/file/d/1kq_PEScbhyjxt8tejuLKpPEuYNecrpA5/view?usp=drivesdk
```
