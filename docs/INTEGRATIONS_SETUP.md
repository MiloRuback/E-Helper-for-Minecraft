...
O workflow `.github/workflows/release.yml` cria a release quando uma tag `v*` e enviada. A versao atual e `v0.1.4`.
...
```text
Every-Helper-for-Minecraft-Setup-0.1.4.exe
https://drive.google.com/file/d/12Sx6IrMElj4vgBGWDYwCITUvn4CxZ37q/view?usp=drivesdk
```
