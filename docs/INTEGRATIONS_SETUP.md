...
O workflow `.github/workflows/release.yml` cria a release quando uma tag `v*` e enviada. A versao atual e `v0.1.3`.
...
```text
Every-Helper-for-Minecraft-Setup-0.1.3.exe
https://drive.google.com/file/d/1gZEIak6WepIDQAi2gmHMZyCgcbZAuXAy/view?usp=drivesdk
```
