...
O workflow `.github/workflows/release.yml` cria a release quando uma tag `v*` e enviada. A versao atual e `v0.1.5`.
...
```text
Every-Helper-for-Minecraft-Setup-0.1.5.exe
https://drive.google.com/file/d/1CZTyDtgh9XK_ycvTbtrK_fd1ZYGz2kYE/view?usp=drivesdk
```
