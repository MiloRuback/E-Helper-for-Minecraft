...
O workflow `.github/workflows/release.yml` cria a release quando uma tag `v*` e enviada. A versao atual e `v0.1.11`.
...
```text
Every-Helper-for-Minecraft-Setup-0.1.11.exe
https://drive.google.com/file/d/14FcdLPbGE1cqPl8X3kR891_BxeXoTwPr/view?usp=drivesdk
```
